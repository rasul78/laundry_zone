                ...
                <div key={idx} className={`card-hover bg-gradient-to-br from-blue-50 to-orange-50 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-lg animate-slideUp ${stat.delay} flex flex-col items-center justify-center`}>
                  {stat.price ? (
                    <div className="text-center">
                      <div className="text-xl sm:text-2xl md:text-3xl font-black bg-gradient-to-r from-blue-600 to-orange-600 bg-clip-text text-transparent mb-2 sm:mb-3">
                        {stat.label}
                      </div>
                      <div className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-orange-600 bg-clip-text text-transparent">
                        {stat.price}
                      </div>
                    </div>
                  ) : (
                    <>
                      ...
                      <div className="text-sm sm:text-base bg-gradient-to-r from-blue-600 to-orange-600 bg-clip-text text-transparent font-semibold text-center">{stat.label}</div>
                    </>
                  )}
                </div>
              ))}
      ...
      {[
        ...
        <div key={idx} className={`card-hover bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-xl animate-slideUp ${service.delay}`}>
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-orange-100 to-orange-200 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
